                            ...
                            <form action="#">
                                <div class="table-content table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <?php
                                              $sql="SELECT * FROM wishlist WHERE user_idx='$user_id'";
                                            ...
                                            <tr>
                                                <td class="product-thumbnail"><a href="product-details.php?id=<?php echo $product_info['id']; ?>"><img src="./product_pictures/<?php echo $product_info['image']; ?>" alt=""></a></td>
                                                ...
                                                <a href="addcart.php?id=<?php echo $product_info['id']; ?>&page=wishlist.php"><button type="button" class="t-y-btn mr-10">Add TO Cart</button></a>
                                                </td>
                                                <td class="product-subtotal"><span class="amount">KSH <?php echo $total_price; ?></span></td>
                                                <td class="product-remove"><a href="remove.php?id=<?php echo $product_info['id']; ?>"><i class="fa fa-times"></i></a></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                    </table>
